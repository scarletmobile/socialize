...
class UserTileState extends State<UserTile> {
  ...
  Widget buildUsers() {
    if (userdoc == null || userdoc!.containsKey('id')) {
      // Handle the case where 'userdoc' is null or missing the 'id' key.
      return Container(); // You can return an empty container or any other appropriate widget.
    }
