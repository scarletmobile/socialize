...
import 'package:soXialz/pages/story_list.dart';
import 'package:soXialz/pages/suggested_users.dart';
...
import 'package:soXialz/widgets/inline_adaptive_ads.dart';
...
class _NewTimelineState extends State<NewTimeline> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Timeline',
          style: TextStyle(color: Color(0xFF39569C)),),
      ),
  ...
  deletePost(post) async {
    ...
    if (isPdf) {
      ...
      FirebaseStorage.instance.refFromURL(post['mediaUrl'].toString()!).delete();
    }
            ...
            children: <Widget>[
              SimpleDialogOption(
                ...
                child: const Text(
                  'Delete',
                  style:
                      TextStyle(color: const Color.fromARGB(255, 57, 86, 156)),
                ),
              ),
              SimpleDialogOption(
